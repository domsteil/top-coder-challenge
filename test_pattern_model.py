#!/usr/bin/env python3
"""
Test the pattern-based percentage model
"""
...
print("Testing pattern-based percentage model...")
...
print(f"\n{'='*60}")
print(f"PATTERN-BASED PERCENTAGE MODEL RESULTS:")
print(f"{'='*60}")
...
print(f"  RandomForest model: Score ~5264 (MAE ~$52.64)")
print(f"  Pattern-based model: Score {int(mae * 100)} (MAE ${mae:.2f})")

if mae < 70:
    print("\n✅ SUCCESS! Achieved target MAE < $70!")
    print(f"   This should achieve a competitive score of ~{int(mae * 100)}!")
else:
